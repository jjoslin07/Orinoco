...
function createPage(e) {
	...
	const l = document.getElementById('productCard'),
		...
		c = e.description,
		r = e.price;
	o.classList.add('mx-auto'),
		l.classList.add('col-xl-6', 'p-0'),
		(o.innerHTML +=
			'<h1 class="mx-auto shop-item-title w-auto">' + d + '</h1>'),
		(o.innerHTML += '<p class="lead mx-auto w-auto">' + c + '</p>'),
		(o.innerHTML +=
			'<p class="lead mx-auto font-weight-bolder">$' + r / 100 + '</p>');
	const s = document.createElement('form'),
		i = document.createElement('label'),
		m = document.createElement('select');
	s.classList.add('my-4'),
		m.classList.add('btn', 'btn-secondary', 'dropdown-toggle', 'w-auto'),
		i.classList.add('font-weight-bold'),
		(i.innerHTML = 'Choose your color&#58; &nbsp;');
	const u = document.createElement('form'),
		p = document.createElement('label'),
		h = document.createElement('select');
	u.classList.add('my-4'),
	...
	for (let t in e.colors) {
		...
		(n.innerHTML = e.colors[t]),
			n.setAttribute('value', e.colors[t]),
			m.appendChild(n);
	}
	...
	u.appendChild(p), u.appendChild(h), s.appendChild(i), s.appendChild(m);
