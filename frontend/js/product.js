...
function createPage(response) {
	...
	productDescription.innerHTML +=
		'<h1 class="mx-auto shop-item-title w-auto">' + title + '</h1>';
	productDescription.innerHTML +=
		'<p class="lead mx-auto w-auto">' + description + '</p>';
	productDescription.innerHTML +=
		'<p class="lead mx-auto font-weight-bolder">' + '$' + price / 100 + '</p>';
	...
	dropdownOptionsColors.classList.add(
		'btn',
		'btn-secondary',
		'dropdown-toggle',
		'w-auto'
	...
	dropDownOptionsQuantity.classList.add(
		'btn',
		'btn-secondary',
		'dropdown-toggle',
		'w-auto'
	 ...
	 */
	addToCart.onclick = () => {
		addedToCartAlert.classList.add(
			'alert',
			'alert-success',
			'p-1',
			'm-0',
		...
		addedToCartAlert.textContent =
			dropDownOptionsQuantity.value +
			' ' +
			response.name +
			' ' +
			'with' +
			' ' +
			dropdownOptionsColors.value +
			' ' +
			'Color' +
			' ' +
			'added to cart!';
